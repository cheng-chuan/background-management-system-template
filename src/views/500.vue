<template>
  <div class="wscn-http500-container">
    <div class="wscn-http500">
      <div class="pic-500">
        <img class="pic-500__parent" src="@/assets/404_images/404.png" alt="500">
      ...
      <div class="bullshit">
        ...
        >当前服务发生异常，请刷新页面重试或联系管理员</div>
        <!-- <a class="bullshit__return-home" @click="$router.push({path:'/home'})">回到首页</a> -->
      </div>
    </div>
  </div>
</template>
