  ...
  >
    ...
    <div style="height:500px;overflow:auto;padding:0 15px">
      ...
      <el-form v-else ref="stepThreeForm" :model="stepThreeForm" label-width="80px">
        ...
        <!-- 空巢孤寡失助老人 -->
        <KCGGSZLR v-if="stepThreeForm.careObject.indexOf('3')!==-1" ref="kcggszlrForm" :dialog-config="dialogConfig" :basic-form="basicForm" @cancelForm="clearCheck" @confirmCareObject="confirmCareObject" />
      </el-form>
    </div>
    <div slot="footer">
      <hr>
...
import KCGGSZLR from './../components/kcggszlr'

export default {
  components: { AddHouseDialog, SQJZ, ZDQSN, ZDSF, SDRY, ZSZH, XMSF, CJR, SYDX, KCGGSZLR },
  props: {
    dialogConfig: {
      type: Object,
      required: true
  ...
  methods: {
    ...
    open() {
      console.log(this.importantPersonList)
      console.log(this.dialogConfig)
      ...
      if (this.dialogConfig.dialogType === 'edit') {
        ...
        this.houseTableList = this.dialogConfig.formData.houseList instanceof Array ? this.dialogConfig.formData.houseList.map(item => {
    ...
    cancelDialog() {
      ...
      this.stepOneForm = {}
      this.stepTwoForm = {}
      this.stepThreeForm = { importantPerson: [], careObject: [] }
