    ...
    <el-form ref="addHouseForm" :model="houseForm" label-width="120px">
      ...
      <el-row :gutter="24">
        <el-form-item label="地址选择：">
          <el-col :span="8">
            <el-select v-model="houseForm.jlxmc" size="small" placeholder="placeholder" @change="jlxmcChange">
              <el-option
          ...
          <el-col :span="8">
            <el-select v-model="houseForm.ldh" size="small" placeholder="placeholder" @change="ldhChange">
              <el-option
          ...
          <el-col :span="8">
            <el-select v-model="houseForm.mlph" size="small" placeholder="placeholder" @change="mlphChnage">
              <el-option
...
<script>
import { getHouseAddress, searchAllDropDownBox, addRegisteredPopulationZF, editRegisteredPopulationZF } from '@/api/information-collection/population/real-population/non-settled-population'
...
export default {
  ...
  computed: {
    get_xjxxdz() {
      return `${this.houseForm.jlxmc},${this.houseForm.ldh},${this.houseForm.mlph}`
    }
  },
  watch: {
    ryzflxdm() {
