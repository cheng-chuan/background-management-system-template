<template>
  ...
  >
    ...
    <div style="height:500px;overflow:auto;padding:0 15px">
      <el-row :gutter="23">
        ...
        <el-col :span="17">
          <el-form ref="basicForm" :model="basicForm" label-width="100px" :rules="rules">
            ...
            <el-row :gutter="24">
              <el-col :span="8">
                <el-form-item label="英文名:" prop="wwm">
                  <el-input v-model="basicForm.wwm" size="small" :disabled="stepOneShow" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="性别:" label-width="100px" prop="xbdm">
            ...
            <el-row :gutter="24">
              <el-col :span="8">
                <el-form-item label="中文名:" label-width="100px" prop="xm">
                  <el-input v-model="basicForm.xm" size="small" :disabled="stepOneShow" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="手机:" prop="lxdh">
                  <el-input v-model="basicForm.lxdh" size="small" :disabled="stepOneShow" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="固定电话:">
                  <el-input v-model="basicForm.telephone" size="small" :disabled="stepOneShow" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="24">
              <el-col :span="8">
                <el-form-item label="返乡来源地:">
                  <ZtDicSelect v-model="basicForm.fxlyd" code="" width="100%" :disabled="stepOneShow" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="接触情况:">
                  <ZtDicSelect v-model="basicForm.jcqk" code="" width="100%" :disabled="stepOneShow" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="24">
              <el-col :span="6" style="padding-rignt:0">
                <el-form-item label="证件号码：">
                  <ZtDicSelect v-model="basicForm.cyzjdm" size="small" code="DM01096" width="100%" :disabled="stepOneShow" />
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="" label-width="0">
                  <el-input v-model="basicForm.zjhm" size="small" placeholder="" :disabled="stepOneShow" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="有效期：">
                  <el-date-picker
                    v-model="basicForm.yxqArr"
                    size="small"
                    type="datetimerange"
      ...
      <hr style="width:99%">
      <!-- 步骤一表单 -->
      <el-form v-if="currentStep === 0" ref="stepOneForm" :model="basicForm" label-width="110px">
        <el-row :gutter="24">
          <el-col :span="8">
            <el-form-item label="是否重点关注人员：" label-width="150px">
              <el-radio-group v-model="basicForm.sfzdgzryPdbz">
        ...
        <el-row :gutter="24">
          <el-col :span="8">
            <el-form-item label="国籍(地区):">
              <ZtDicSelect v-model="basicForm.gjhdqdm" size="small" code="DM01041" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="职业:">
              <el-select v-model="basicForm.cyzkZylbdm" filterable size="small" placeholder="请选择职业">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="服务处所:">
              <el-input v-model="basicForm.cyzkDwmc" placeholder="" size="small" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="8">
            <el-form-item label="来华目的:">
              <ZtDicSelect v-model="basicForm.lhmddm" size="small" code="DM01524" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="抵达时间:">
              <el-date-picker
                v-model="basicForm.ddbdsjRq"
                size="small"
                type="datetime"
                placeholder="选择日期时间"
                style="width:100%"
        ...
        <el-row :gutter="23">
          <el-form-item label="备注:">
            <el-input v-model="basicForm.bz" size="small" type="textarea" rows="3" placeholder="" />
          </el-form-item>
        </el-row>
      </el-form>
      <!-- 步骤二表单 -->
        ...
        <el-row :gutter="24">
          <el-col :span="8">
            <el-form-item label="人口类型：">
              <el-radio-group v-model="stepTwoForm.lklx">
                <el-radio label="1">境外人口</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
...
<script>
import { addRegisteredPopulation, editRegisteredPopulation, searchAllDropDownBox, addRegisteredPopulationHK, deleteRegisteredPopulationZF } from '@/api/information-collection/population/real-population/overseas-population'
      ...
      if (this.dialogConfig.dialogType === 'add') { // 新增
        ...
        if (this.currentStep === 1) {
          this.$confirm('是否保存基础信息?', '提示', {
            ...
            this.basicForm.zjhmYxqksrq = this.basicForm.yxqArr[0]
            this.basicForm.zjhmYxqjzrq = this.basicForm.yxqArr[1]
            console.log(this.basicForm)
