      ...
      <el-form ref="addHouseForm" :model="houseForm" label-width="120px">
        ...
        <el-row :gutter="24">
          <el-form-item label="地址选择：">
            <el-col :span="8">
              <el-select v-model="houseForm.mlxz" size="small" placeholder="placeholder" @change="jlxmcChange">
                <el-option
            ...
            <el-col :span="8">
              <el-select v-model="houseForm.dzmc" size="small" placeholder="placeholder" @change="ldhChange">
                <el-option
...
<script>
import { getHouseAddress, searchAllDropDownBox, addRegisteredPopulationZF, editRegisteredPopulationZF } from '@/api/information-collection/population/real-population/overseas-population'
