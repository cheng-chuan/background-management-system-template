  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <ZtDictLabel code="DM01041" :value="scope.row.gjhdqdm" />
          </template>
        </el-table-column>
        <el-table-column
          prop="lxdh"
...
<script>
import { deleteRegisteredPopulation, getRegisteredPopulationZFList } from '@/api/information-collection/population/real-population/overseas-population'
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      row.yxqArr = row.zjhmYxqksrq && row.zjhmYxqjzrq ? [row.zjhmYxqksrq, row.zjhmYxqjzrq] : []
