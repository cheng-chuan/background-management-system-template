  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-link type="primary" @click="showDetailDialog(scope.$index, scope.row)">{{ scope.row.xm }}</el-link>
          </template>
        </el-table-column>
        <el-table-column
          prop="xbdm"
      ...
      <DetailDialog
        ref="detailTable"
        :detail-dialog-config="detailDialogConfig"
      />
    </el-main>
  </el-container>
</template>
...
import { deleteRegisteredPopulation, getRegisteredPopulationZFList } from '@/api/information-collection/population/real-population/registered-population'
...
export default {
  ...
  methods: {
    ...
    showDetailDialog(index, row) {
      // console.log(row)
      this.detailDialogConfig.detailForm = row
      this.detailDialogConfig.dialogVisible = true
    },
    sexy(row, column) {
