...
<script>
import { getHouseAddress, searchAllDropDownBox, addRegisteredPopulationZF, editRegisteredPopulationZF } from '@/api/information-collection/population/real-population/registered-population'
