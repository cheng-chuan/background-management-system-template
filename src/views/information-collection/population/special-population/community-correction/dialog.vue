<template>
  ...
  >
    ...
    <div style="height:500px;overflow:auto;padding:0 15px">
      ...
      <!-- 步骤三 -->
      <el-form v-else ref="stepThreeForm" :model="stepThreeForm" label-width="150px">
        <el-row :gutter="24">
          <el-form-item label="社区服刑人员" />
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="社区服刑人员编号：" prop="xxzjbh">
              <el-input v-model="stepThreeForm.xxzjbh" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="接受方式:" prop="jsfsdm">
              <el-select v-model="stepThreeForm.jsfsdm" placeholder="请选择" size="medium">
                <el-option
                  v-for="item in allList.jsfsdmList"
                  :key="item.dictDetailName"
                  :label="item.dictDetailName"
                  :value="item.dictDetailValue"
                />
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="关注程度：" prop="gzcddm">
              <el-select v-model="stepThreeForm.gzcddm" placeholder="请选择" size="medium">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="原羁押场所:" prop="yjycsDwmc">
              <el-input v-model="stepThreeForm.yjycsDwmc" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="犯罪类型：" prop="fzlxdm">
              <el-select v-model="stepThreeForm.fzlxdm" placeholder="请选择" size="medium">
                <el-option
                  v-for="item in allList.fzlxdmList"
                  :key="item.dictDetailName"
                  :label="item.dictDetailName"
                  :value="item.dictDetailValue"
                />
          ...
          <el-col :span="12">
            <el-form-item label="具体罪名：" prop="zm">
              <el-input v-model="stepThreeForm.zm" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="四史情况：" prop="ssqkdm">
              <ZtDicSelect v-model="stepThreeForm.ssqkdm" code="LM00026" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="三涉情况：" prop="sasqkdm">
              <ZtDicSelect v-model="stepThreeForm.sasqkdm" code="LM00027" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="是否累惯犯：" prop="sflgfPdbz">
              <ZtDicSelect v-model="stepThreeForm.sflgfPdbz" code="DM01117" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="服刑类别：" prop="jzlbdm">
              <ZtDicSelect v-model="stepThreeForm.jzlbdm" code="LM00024" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="原判刑期:" prop="ypxq">
              <el-input v-model="stepThreeForm.ypxq" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="原判刑期开始时间：" prop="ypxqKsrq">
              <el-date-picker
                v-model="stepThreeForm.ypxqKsrq"
                size="small"
                type="datetime"
                placeholder="选择日期时间"
                style="width:100%"
          ...
          <el-col :span="12">
            <el-form-item label="原判刑期结束时间:" prop="ypxqJsrq">
              <el-date-picker
                v-model="stepThreeForm.ypxqJsrq"
                size="small"
                type="datetime"
                placeholder="选择日期时间"
                style="width:100%"
        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="至:" label-width="120px" prop="jzJsrq">
              <el-date-picker
                v-model="stepThreeForm.jzJsrq"
                size="small"
                type="datetime"
                placeholder="选择日期时间"
                style="width:100%"
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="案件类别：" prop="ajlbdm">
              <ZtDicSelect v-model="stepThreeForm.ajlbdm" code="DM00001" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否建立矫正小组：" prop="sfjljzxzPdbz">
              <ZtDicSelect v-model="stepThreeForm.sfjljzxzPdbz" code="DM01117" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="是否重新犯罪：" prop="sfzxfzPdbz">
              <ZtDicSelect v-model="stepThreeForm.sfzxfzPdbz" code="DM01117" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="重犯罪名：" prop="zxfzZm">
              <el-input v-model="stepThreeForm.zxfzZm" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="是否有脱管：" prop="sfytgPdbz">
              <ZtDicSelect v-model="stepThreeForm.sfytgPdbz" code="DM01117" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否有漏管：" prop="sfylgPdbz">
              <ZtDicSelect v-model="stepThreeForm.sfylgPdbz" code="DM01117" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="脱管原因：" prop="tgjzqkXxqk">
              <el-input v-model="stepThreeForm.tgjzqkXxqk" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="漏管原因：" prop="lgyyXxqk">
              <el-input v-model="stepThreeForm.lgyyXxqk" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="近况描述：" prop="jkms">
              <el-input v-model="stepThreeForm.jkms" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="附件上传：" prop="fjxxXxzjbh">
              <el-input v-model="stepThreeForm.fjxxXxzjbh" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import { addCommunityInfo, editCommunityInfo } from '@/api/information-collection/population/special-population/community-correction'
...
export default {
  ...
  created() {
    ...
    this.getDropDownList('LM00025')
    this.getDropDownList('LM00026')
    this.getDropDownList('LM00027')
    this.getDropDownList('DM01117')
  },
  methods: {
    ...
    open() {
      ...
      if (this.dialogConfig.dialogType === 'edit') {
        ...
        this.stepThreeForm = this.dialogConfig.communityData
      ...
      searchAllDropDownBox(params).then(res => {
        ...
        switch (data) {
          ...
          case 'DM01474':
            ...
            break
          case 'LM00025':
            this.allList.jsfsdmList = res.data.datas
            break
          default:
            break
        }
    ...
    lastCommittPopulationInfo() {
      ...
      this.stepThreeForm.lxdh = this.basicForm.lxdh
      this.stepThreeForm.sfwffzPdbz = this.stepThreeForm.sfwffzPdbz ? '1' : '0'
      ...
      if (this.dialogConfig.dialogType === 'add') {
        ...
        this.$confirm('是否保存业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.addCommunityInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消保存'
          })
        ...
        this.$confirm('是否修改业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.editCommunityInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消修改'
          })
