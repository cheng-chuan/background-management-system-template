...
<script>
import { getBasicDetail } from '@/api/information-collection/population/special-population/community-correction'
import { delCommunityInfo } from '@/api/information-collection/population/special-population/community-correction'
  ...
  methods: {
    ...
    handleDelete(index, row) {
      this.$confirm('是否删除信息?', '提示', {
        ...
        delCommunityInfo(row.xxzjbh).then(res => {
          console.log(res)
