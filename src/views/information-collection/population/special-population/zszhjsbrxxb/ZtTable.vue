...
<script>
import { getBasicDetail, delYZHZSInfo } from '@/api/information-collection/population/special-population/zszhjsbrxxb'
...
export default {
  ...
  methods: {
    ...
    mqwxxpgdjdm(row, column) {
      switch (row.mqwxxpgdjdm) {
        case '1':
          return '高'
        case '2':
          return '中'
    ...
    handleDelete(index, row) {
      this.$confirm('是否删除信息?', '提示', {
        ...
        delYZHZSInfo(row.xxzjbh).then(res => {
          console.log(res)
