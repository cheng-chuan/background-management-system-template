  ...
  <div class="app-container">
    ...
    <ZtViewLayout>
      ...
      <template #operate-left>
        ...
        <el-button size="mini" disabled>领导视图</el-button>
      </template>
...
import { getList, delYZHZSInfos } from '@/api/information-collection/population/special-population/zszhjsbrxxb'
...
export default {
  ...
  data() {
    return {
      ...
      dialogConfig: {
        title: '新增易肇事肇祸严重精神障碍患者',
        dialogType: 'add',
        dialogVisible: false
      },
      editConfig: {
        title: '修改易肇事肇祸严重精神障碍患者',
        dialogType: 'edit',
        dialogVisible: false,
        formData: null
      }
