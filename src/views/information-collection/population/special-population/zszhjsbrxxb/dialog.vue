        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="危险程度：">
              <ZtDicSelect v-model="stepThreeForm.mqwxxpgdjdm" code="LM00060" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="患病名称：">
              <el-input v-model="stepThreeForm.hbmc" size="small" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="初次发病日期：">
              <el-date-picker
                v-model="stepThreeForm.ccfbrqRq"
                type="datetime"
                placeholder="选择日期"
                value-format="yyyy-MM-dd HH:mm:ss"
                size="small"
          ...
          <el-col :span="12">
            <el-form-item label="有无肇事肇祸史：">
              <ZtDicSelect v-model="stepThreeForm.ywzszhsPdbz" code="DM01117" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="家庭经济状况：">
              <ZtDicSelect v-model="stepThreeForm.jtjjzkdm" code="DM01493" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否纳入低保：">
              <ZtDicSelect v-model="stepThreeForm.sfnrdbPdbz" code="DM01117" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="是否接受过治疗：">
              <ZtDicSelect v-model="stepThreeForm.sfjsgzl" code="DM01117" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="康复机构：">
              <el-input v-model="stepThreeForm.jskfxljgDwmc" size="small" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="监护人联系方式：">
              <el-input v-model="stepThreeForm.jhrLxhm" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="治疗医院：">
              <el-input v-model="stepThreeForm.zlyyDwmc" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="诊断类型：">
              <ZtDicSelect v-model="stepThreeForm.zdlxdm" code="DM01496" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="治疗情况：">
              <ZtDicSelect v-model="stepThreeForm.zlqkdm" code="LM00033" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
...
import { addYZHZSInfo, editYZHZSInfo } from '@/api/information-collection/population/special-population/zszhjsbrxxb'
  ...
  methods: {
    ...
    open() {
      ...
      if (this.dialogConfig.dialogType === 'edit') {
        ...
        this.stepThreeForm = this.dialogConfig.YZHZSData
    ...
    lastCommittPopulationInfo() {
      ...
      if (this.dialogConfig.dialogType === 'add') {
        ...
        this.$confirm('是否保存业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.addYZHZSInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消保存'
          })
        ...
        this.$confirm('是否修改业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.editYZHZSInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消修改'
          })
