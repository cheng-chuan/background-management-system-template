  ...
  <div class="app-container">
    ...
    <ZtViewLayout>
      ...
      <template #operate-left>
        ...
        <el-button size="mini" disabled>安置就业</el-button>
...
import { getList, delDrugInfos } from '@/api/information-collection/population/special-population/drug-related-population'
