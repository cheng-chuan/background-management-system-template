        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="吸毒状态:" prop="xdztdm">
              <ZtDicSelect v-model="stepThreeForm.xdztdm" code="LM99322" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="管控情况：" prop="gkxzdm">
              <ZtDicSelect v-model="stepThreeForm.gkxzdm" code="LM00037" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="吸毒原因:" prop="xdyydm">
              <ZtDicSelect v-model="stepThreeForm.xdyydm" code="DM01051" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="毒品来源：" prop="dplydm">
              <ZtDicSelect v-model="stepThreeForm.dplydm" code="DM00899" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="戒毒情况:" prop="jdqkdm">
              <ZtDicSelect v-model="stepThreeForm.jdqkdm" code="LM99321" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="滥用毒品种类：" prop="lydpzldm">
              <ZtDicSelect v-model="stepThreeForm.lydpzldm" code="DM00339" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否服美沙酮戒毒:" label-width="130px" prop="sffmstjd">
              <el-checkbox v-model="stepThreeForm.sffmstjd" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="犯罪情况：" prop="fzqk">
              <el-input v-model="stepThreeForm.fzqk" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="有无违法犯罪史:" prop="sfywffzsPdbz">
              <el-checkbox v-model="stepThreeForm.sfywffzsPdbz" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
...
import { addDrugInfo, editDrugInfo } from '@/api/information-collection/population/special-population/drug-related-population'
  ...
  methods: {
    ...
    open() {
      ...
      if (this.dialogConfig.dialogType === 'edit') {
        ...
        this.stepThreeForm = this.dialogConfig.drugData
    ...
    lastCommittPopulationInfo() {
      ...
      this.stepThreeForm.sffmstjd = this.stepThreeForm.sffmstjd ? '1' : '0'
      this.stepThreeForm.sfywffzsPdbz = this.stepThreeForm.sfywffzsPdbz ? '1' : '0'
      ...
      if (this.dialogConfig.dialogType === 'add') {
        ...
        this.$confirm('是否保存业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.addDrugInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消保存'
          })
        ...
        this.$confirm('是否修改业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.editDrugInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消修改'
          })
