<template>
  ...
  >
    ...
    <div style="height:500px;overflow:auto;padding:0 15px">
      ...
      <!-- 步骤三 -->
      <el-form v-else ref="stepThreeForm" :model="stepThreeForm" :rules="rules" label-width="150px">
        <el-row :gutter="23">
          <el-form-item label="重点青少年：" />
        </el-row>
        <el-row :gutter="20">
          ...
          <el-col :span="10" :offset="0">
            <el-form-item label="管理手段：" prop="bfsddm">
              <el-select v-model="stepThreeForm.bfsddm" size="small" placeholder="请选择">
                <el-option
                  v-for="item in allList.bfsdList"
                  :key="item.dictDetailName"
                  :label="item.dictDetailName"
                  :value="item.dictDetailValue"
                />
        ...
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="违法情况：" prop="wflxdm">
              <el-select v-model="stepThreeForm.wflxdm" placeholder="请选择" size="medium">
          ...
          <el-col :span="10" :offset="0">
            <el-form-item label="犯罪类型：" prop="fzlxdm">
              <el-select v-model="stepThreeForm.fzlxdm" size="small" placeholder="请选择">
                <el-option
        ...
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="学校所属层次：" prop="xxxscjdm">
              <el-select v-model="stepThreeForm.xxxscjdm" placeholder="请选择" size="medium">
                <el-option
                  v-for="item in allList.jyxxmcList"
                  :key="item.dictDetailName"
                  :label="item.dictDetailName"
                  :value="item.dictDetailValue"
                />
          ...
          <el-col :span="10" :offset="0">
            <el-form-item label="教育学校名称：" prop="jyxxmc">
              <el-input v-model="stepThreeForm.jyxxmc" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="人员类型：" prop="rylxdm">
              <el-select v-model="stepThreeForm.rylxdm" placeholder="请选择" size="medium">
                <el-option
                  v-for="item in allList.rylxdmList"
                  :key="item.dictDetailName"
                  :label="item.dictDetailName"
                  :value="item.dictDetailValue"
                />
        ...
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="帮扶人姓名：" prop="bfrXm">
              <el-input v-model="stepThreeForm.bfrXm" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="10" :offset="0">
            <el-form-item label="帮扶人联系方式：" prop="bfrLxdh">
              <el-input v-model="stepThreeForm.bfrLxdh" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="家庭情况：" prop="jtqkdm">
              <el-select v-model="stepThreeForm.jtqkdm" placeholder="请选择" size="medium">
                <el-option
                  v-for="item in allList.jtqkdmList"
                  :key="item.dictDetailName"
                  :label="item.dictDetailName"
                  :value="item.dictDetailValue"
                />
          ...
          <el-col :span="10" :offset="0">
            <el-form-item label="是否违法犯罪：" prop="sfwffzPdbz">
              <el-checkbox v-model="stepThreeForm.sfwffzPdbz" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="监护人身份证号：" prop="jhrGmsfhm">
              <el-input v-model="stepThreeForm.jhrGmsfhm" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="10" :offset="0">
            <el-form-item label="监护人姓名：" prop="jhrXm">
              <el-input v-model="stepThreeForm.jhrXm" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="监护人联系方式：" prop="jhrLxdh">
              <el-input v-model="stepThreeForm.jhrLxdh" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="10" :offset="0">
            <el-form-item label="监护关系：" prop="yjhrgx">
              <el-select v-model="stepThreeForm.yjhrgx" placeholder="请选择" size="medium">
                <el-option
                  v-for="item in allList.yjhrgxList"
                  :key="item.dictDetailName"
                  :label="item.dictDetailName"
                  :value="item.dictDetailValue"
                />
        ...
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="监护人居住详址：" prop="jhrQhnxxdz">
              <el-input v-model="stepThreeForm.jhrQhnxxdz" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="附件上传：" prop="fjscdz">
              <el-input v-model="stepThreeForm.fjscdz" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import { addYoungInfo, editYoungInfo } from '@/api/information-collection/population/special-population/important-young'
        ...
        if (valid) {
          ...
          if (this.dialogConfig.dialogType === 'add') {
            ...
            this.$confirm('是否保存业务信息?', '提示', {
              ...
              console.log(this.stepThreeForm)
              this.addYoungInfo(this.stepThreeForm)
            }).catch(() => {
              this.$message.info({
                message: '已取消保存'
              })
            ...
            this.$confirm('是否修改业务信息?', '提示', {
              ...
              console.log(this.stepThreeForm)
              this.editYoungInfo(this.stepThreeForm)
            }).catch(() => {
              this.$message.info({
                message: '已取消修改'
              })
