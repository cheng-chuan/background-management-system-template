<template>
  ...
  >
    ...
    <div style="height:500px;overflow:auto;padding:0 15px">
      ...
      <!-- 步骤三 -->
      <el-form v-else ref="stepThreeForm" :model="stepThreeForm" label-width="120px">
        <el-row :gutter="23">
          <el-form-item label="重点上访人员" />
        </el-row>
        <el-row :gutter="20">
          ...
          <el-col :span="10" :offset="0">
            <el-form-item label="上访状态:" label-width="120px" prop="gzcddm">
              <el-select v-model="stepThreeForm.sfztdm" size="small" placeholder="请选择">
                <el-option
                  v-for="item in allList.sfztdmList"
                  :key="item.dictDetailName"
                  :label="item.dictDetailName"
                  :value="item.dictDetailValue"
                />
        ...
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="事发地：" prop="gzcddm">
              <el-input v-model="stepThreeForm.sfd" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="10" :offset="0">
            <el-form-item label="上访类型：" prop="gzcddm">
              <!-- <el-select v-model="stepThreeForm.sflxdm" size="small" placeholder="请选择">
              ...
              <ZtDicSelect v-model="stepThreeForm.sflxdm" code="DM98561" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="10" :offset="2">
            <el-form-item label="上访原因：" prop="gzcddm">
              <el-input v-model="stepThreeForm.sfyyYy" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
...
import { addVisitInfo, editVisitInfo } from '@/api/information-collection/population/special-population/important-visit'
  ...
  methods: {
    ...
    open() {
      ...
      if (this.dialogConfig.dialogType === 'edit') {
        ...
        this.stepThreeForm = this.dialogConfig.visitData
      ...
      searchAllDropDownBox(params).then(res => {
        ...
        switch (data) {
          ...
          case 'DM01474':
            ...
            break
          case 'LM99327':
            this.allList.sfztdmList = res.data.datas
            break
          default:
            break
        }
    ...
    lastCommittPopulationInfo() {
      ...
      if (this.dialogConfig.dialogType === 'add') {
        ...
        this.$confirm('是否保存业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.addVisitInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消保存'
          })
        ...
        this.$confirm('是否修改业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.editVisitInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消修改'
          })
