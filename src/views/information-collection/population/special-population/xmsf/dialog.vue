<template>
  ...
  >
    ...
    <div style="height:500px;overflow:auto;padding:0 15px">
      ...
      <!-- 步骤三 -->
      <el-form v-else ref="stepThreeForm" :model="stepThreeForm" label-width="140px">
        <el-row :gutter="24">
          <el-form-item label="刑满释放人员" />
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="关注程度：">
              <ZtDicSelect v-model="stepThreeForm.gzcddm" code="DM01474" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="犯罪类型：">
              <ZtDicSelect v-model="stepThreeForm.fzlxdm" code="LM10100" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="服刑（劳教）场所：">
              <el-input v-model="stepThreeForm.fxcsDwmc" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="本年度是否重犯：">
              <ZtDicSelect v-model="stepThreeForm.sfcxfzPdbz" code="DM01117" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="是否脱管：">
              <ZtDicSelect v-model="stepThreeForm.jgzt" code="DM01117" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="危险性评估：">
              <ZtDicSelect v-model="stepThreeForm.wxxpglxdm" code="LM00021" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否累犯：">
              <ZtDicSelect v-model="stepThreeForm.sflfPdbz" code="DM01117" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="帮教情况：">
              <ZtDicSelect v-model="stepThreeForm.bjqkXxqk" code="LM00036" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否已安置：">
              <ZtDicSelect v-model="stepThreeForm.azqkdm" code="DM01462" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="衔接情况：">
              <ZtDicSelect v-model="stepThreeForm.xjqkdm" code="LM00022" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="关注年限：">
              <el-input v-model="stepThreeForm.gznx" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="犯罪行为：">
              <el-input v-model="stepThreeForm.fzxw" size="small" placeholder="" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="未安置原因：">
              <el-input v-model="stepThreeForm.wazyyXxqk" size="small" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
...
import { addXMSFInfo, editXMSFInfo } from '@/api/information-collection/population/special-population/xmsf'
  ...
  methods: {
    ...
    open() {
      ...
      if (this.dialogConfig.dialogType === 'edit') {
        ...
        this.stepThreeForm = this.dialogConfig.XMSFData
    ...
    lastCommittPopulationInfo() {
      ...
      if (this.dialogConfig.dialogType === 'add') {
        ...
        this.$confirm('是否保存业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.addXMSFInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消保存'
          })
        ...
        this.$confirm('是否修改业务信息?', '提示', {
          ...
          console.log(this.stepThreeForm)
          this.editXMSFInfo(this.stepThreeForm)
        }).catch(() => {
          this.$message.info({
            message: '已取消修改'
          })
