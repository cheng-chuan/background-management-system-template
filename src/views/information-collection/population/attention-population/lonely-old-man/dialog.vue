  ...
  >
    ...
    <div style="height:500px;overflow:auto;padding:0 15px">
      ...
      <el-form v-else ref="stepThreeForm" :model="stepThreeForm" :rules="rules" label-width="120px">
        <el-row :gutter="23">
          <el-form-item label="空巢孤寡失助老人：" label-width="180px" />
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="老人类别:" prop="lrlbdm" label-width="180px">
              <ZtDicSelect v-model="stepThreeForm.lrlbdm" code="DM01458" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否独生子女家庭:" prop="sfdsznjtPdbz" label-width="180px">
              <ZtDicSelect v-model="stepThreeForm.sfdsznjtPdbz" code="DM01117" width="100%" />
            </el-form-item>
          </el-col>
          <!-- <el-col :span="12">
            <el-form-item label="单位名称:" prop="dwmc">
              <el-input v-model="stepThreeForm.dwmc" size="small" label-width="100px" />
            </el-form-item>
          </el-col> -->
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="离退休前单位_工作性质:" prop="ltxqdwGzxzdm" label-width="180px">
              <ZtDicSelect v-model="stepThreeForm.ltxqdwGzxzdm" code="DM01476" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="离退休日期:" prop="tlxrqRq" label-width="180px">
              <el-date-picker
                v-model="stepThreeForm.tlxrqRq"
                size="small"
                type="datetime"
                placeholder="选择日期时间"
                style="width:100%"
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="离退休前单位_职务:" prop="ltxqdwSfhzw" label-width="180px">
              <el-input v-model="stepThreeForm.ltxqdwSfhzw" size="small" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="退休工资_金额:" prop="txgzJe" label-width="180px">
              <el-input v-model="stepThreeForm.txgzJe" size="small" label-width="100px" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="生活照料情况:" prop="shzlqk" label-width="180px">
              <ZtDicSelect v-model="stepThreeForm.shzlqk" code="DM01492" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="健康状况:" prop="jkzkdm" label-width="180px">
              <ZtDicSelect v-model="stepThreeForm.jkzkdm" code="DM00146" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="生活自理能力:" prop="shzlnldm" label-width="180px">
              <ZtDicSelect v-model="stepThreeForm.shzlnldm" code="DM01500" width="100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="居住状况:" prop="jzzkdm" label-width="180px">
              <ZtDicSelect v-model="stepThreeForm.jzzkdm" code="DM01504" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <!-- <el-row :gutter="24">
...
import { addLNRInfo, editLNRInfo } from '@/api/information-collection/population/attention-population/lonely-old-man'
        ...
        if (valid) {
          ...
          if (this.dialogConfig.dialogType === 'add') {
            ...
            this.$confirm('是否保存业务信息?', '提示', {
              ...
              console.log(this.stepThreeForm)
              this.addLNRInfo(this.stepThreeForm)
            }).catch(() => {
              this.$message.info({
                message: '已取消保存'
              })
            ...
            this.$confirm('是否修改业务信息?', '提示', {
              ...
              console.log(this.stepThreeForm)
              this.editLNRInfo(this.stepThreeForm)
            }).catch(() => {
              this.$message.info({
                message: '已取消修改'
              })
