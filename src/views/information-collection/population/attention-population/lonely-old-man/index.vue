...
import { getList, delLNRInfo } from '@/api/information-collection/population/attention-population/lonely-old-man'
...
export default {
  ...
  methods: {
    initTableList(params) {
      const newParams = { current: params.pageNo, size: params.pageSize }
