        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="人员类型:" prop="rylbdm">
              <ZtDicSelect v-model="stepThreeForm.rylbdm" code="DM00316" width="100%" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="个人简介:" prop="grjlXxqk">
              <el-input
                v-model="stepThreeForm.grjlXxqk"
                type="textarea"
                :rows="2"
                placeholder="请输入内容"
              />
...
import { addSYDXInfo, editSYDXInfo } from '@/api/information-collection/population/attention-population/double-support'
        ...
        if (valid) {
          ...
          if (this.dialogConfig.dialogType === 'add') {
            ...
            this.$confirm('是否保存业务信息?', '提示', {
              ...
              console.log(this.stepThreeForm)
              this.addSYDXInfo(this.stepThreeForm)
            }).catch(() => {
              this.$message.info({
                message: '已取消保存'
              })
            ...
            this.$confirm('是否修改业务信息?', '提示', {
              ...
              console.log(this.stepThreeForm)
              this.editSYDXInfo(this.stepThreeForm)
            }).catch(() => {
              this.$message.info({
                message: '已取消修改'
              })
