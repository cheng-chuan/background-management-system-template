...
export function getList(data) {
  data.syrkgllbdm = '20'
  return request({
    url: `${API_MODULE.COMPREHENSIVE_GOVERN}/jwryxxb/page`,
    method: 'post',
...
export function addRegisteredPopulation(data) {
  data.syrkgllbdm = '20'
  return request({
    url: `${API_MODULE.COMPREHENSIVE_GOVERN}/jwryxxb/`,
    method: 'post',
    data
  })
}
...
export function deleteRegisteredPopulation(data) {
  return request({
    url: `${API_MODULE.COMPREHENSIVE_GOVERN}/jwryxxb/deleteIds`,
    method: 'put',
    data
  })
}
...
export function getHouseAddress(data) {
  return request({
    url: `${API_MODULE.COMPREHENSIVE_GOVERN}/dzFwxxb/list?mlxz=${data.mlxz}&dzmc=${data.dzmc}&typeStr=${data.typeStr}`,
    method: 'get',
    data
  })
}
