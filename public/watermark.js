(function (root, factory) {
  ...
  var defaultSettings = {
    ...
    watermark_txt: "扬州市广陵区12345平台",             //水印的内容
    ...
    watermark_stagger: false         //水印奇偶错开
  };
  ...
  var loadMark = function (settings) {
    ...
    if (defaultSettings.watermark_stagger) {
    ...
    for (var i = 0; i < defaultSettings.watermark_rows; i++) {
      ...
      for (var j = 0; j < defaultSettings.watermark_cols; j++) {
        ...
        if (defaultSettings.watermark_stagger && i % 2 === 0) {
          x -= (defaultSettings.watermark_width + defaultSettings.watermark_x_space) / 2
        }
